...
logger.info('Info message - This provides general information about the package behavior.')
logger.warning('Warning message - Something is not quite right, but the package is still working.')
